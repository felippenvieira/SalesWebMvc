...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(1, "Maria Green", "maria@gmail.com", new DateTime(1978, 4, 21), 3500.0, d1);
            Seller s3 = new Seller(1, "Alex Grey", "alex@gmail.com", new DateTime(1994, 4, 21), 2200.0, d1);
            Seller s4 = new Seller(1, "Martha Reed", "martha@gmail.com", new DateTime(1956, 4, 21), 3000.0, d1);
            Seller s5 = new Seller(1, "Donald Blue", "donald@gmail.com", new DateTime(1997, 4, 21), 4000.0, d1);
            Seller s6 = new Seller(1, "Alex Pink", "alex@gmail.com", new DateTime(1958, 4, 21), 3000.0, d1);
